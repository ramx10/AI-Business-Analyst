...
with col7:
    ...
    <div class="custom-card" style="min-height: 200px;">
        <div style="font-size: 32px; margin-bottom: 12px;">✦</div>
        <div style="font-size: 18px; font-weight: 600; color: #ffffff; margin-bottom: 8px;">7. Pipeline Builder</div>
        <div style="font-size: 14px; color: #94a3b8; line-height: 1.5;">Select individual cleaning steps to run instead of the full pipeline. Preview changes, execute selectively, and download the cleaned dataset.</div>
    </div>
    """, unsafe_allow_html=True)
